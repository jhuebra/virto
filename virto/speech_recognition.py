...
class Recognizer(AudioSource):
    def __init__(self):
        ...
        """
        self.sphinx_decoder = {} # language - decoder
    ...
    def _get_recognize_sphinx(self, language="en-US", keyword_entries=None):
        ...
        if language in self.sphinx_decoder:
            return self.sphinx_decoder[language]
    ...
    def recognize_sphinx_keyword(self, audio_data, keyword_entries, language="en-US", show_all=False):
        ...
        decoder = self.get_recognize_sphinx(language=language, keyword_entries=keyword_entries)

        # obtain audio data. Necesario????
